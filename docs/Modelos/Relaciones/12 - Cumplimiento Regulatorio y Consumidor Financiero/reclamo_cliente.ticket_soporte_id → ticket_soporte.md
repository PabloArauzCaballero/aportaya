...
columna: ticket_soporte_id
destino: ticket_soporte
modulo_origen: "12"
modulo_destino: "09"
cross_modulo: true
opcional: true
...
# reclamo_cliente.ticket_soporte_id → ticket_soporte
...
| Entidad destino | [[ticket_soporte]] (módulo 09) |
| Columna | `ticket_soporte_id` — UUID |
| Cardinalidad | no declarada en el diagrama |
