...
tags:
  ...
  - cross-modulo
origen: evidencia_incumplimiento
columna: aportada_por
destino: usuario
modulo_origen: "08"
modulo_destino: "01"
cross_modulo: true
...
# evidencia_incumplimiento.aportada_por → usuario

> **[[evidencia_incumplimiento]]** `.aportada_por` → **[[usuario]]**

| | |
| --- | --- |
| Entidad origen | [[evidencia_incumplimiento]] (módulo 08) |
| Entidad destino | [[usuario]] (módulo 01) |
| Columna | `aportada_por` — UUID |
| Cardinalidad | no declarada en el diagrama |
