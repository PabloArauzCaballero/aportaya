...
tags:
  ...
  - cross-modulo
origen: descargo_participante
columna: resuelto_por
destino: usuario
modulo_origen: "08"
modulo_destino: "01"
cross_modulo: true
...
# descargo_participante.resuelto_por → usuario

> **[[descargo_participante]]** `.resuelto_por` → **[[usuario]]**

| | |
| --- | --- |
| Entidad origen | [[descargo_participante]] (módulo 08) |
| Entidad destino | [[usuario]] (módulo 01) |
| Columna | `resuelto_por` — UUID |
| Cardinalidad | no declarada en el diagrama |
