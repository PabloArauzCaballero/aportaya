...
origen: estado_cuenta_billetera
...
# estado_cuenta_billetera.cuenta_billetera_id → cuenta_billetera

> **[[estado_cuenta_billetera]]** `.cuenta_billetera_id` → **[[cuenta_billetera]]**

| | |
| --- | --- |
| Entidad origen | [[estado_cuenta_billetera]] (módulo 10) |
