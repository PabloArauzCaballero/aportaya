...
ALTER TABLE abono_recuperacion
  ADD CONSTRAINT fk_abono_recuperacion_deuda_id
  FOREIGN KEY (deuda_id) REFERENCES deuda_participante (id) ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE abono_recuperacion
  ADD CONSTRAINT fk_abono_recuperacion_entrega_id
  FOREIGN KEY (entrega_id) REFERENCES entrega_fondo (id) ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE abono_recuperacion
  ADD CONSTRAINT fk_abono_recuperacion_movimiento_fondo_id
  FOREIGN KEY (movimiento_fondo_id) REFERENCES movimiento_fondo (id) ON DELETE SET NULL ON UPDATE CASCADE;
...
ALTER TABLE accion_cobranza
  ...
  FOREIGN KEY (gestion_id) REFERENCES gestion_cobranza (id) ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE accion_cobranza
  ADD CONSTRAINT fk_accion_cobranza_notificacion_id
  FOREIGN KEY (notificacion_id) REFERENCES notificacion (id) ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE acuerdo_quita
  ADD CONSTRAINT fk_acuerdo_quita_acuerdo_grupo_id
  FOREIGN KEY (acuerdo_grupo_id) REFERENCES acuerdo (id) ON DELETE SET NULL ON UPDATE CASCADE;
...
ALTER TABLE acuerdo_quita
  ...
  FOREIGN KEY (registro_id) REFERENCES registro_incumplimiento (id) ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE alerta_temprana
...
ALTER TABLE apelacion_sancion
  ADD CONSTRAINT fk_apelacion_sancion_apelante_id
  FOREIGN KEY (apelante_id) REFERENCES usuario (id) ON DELETE RESTRICT ON UPDATE CASCADE;
...
ALTER TABLE apelacion_sancion
  ...
  FOREIGN KEY (sancion_id) REFERENCES sancion (id) ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE aval_participante
  ADD CONSTRAINT fk_aval_participante_avalista_usuario_id
  FOREIGN KEY (avalista_usuario_id) REFERENCES usuario (id) ON DELETE RESTRICT ON UPDATE CASCADE;
...
ALTER TABLE aval_participante
  ...
  FOREIGN KEY (participante_avalado_id) REFERENCES participante (id) ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE aval_participante
  ADD CONSTRAINT fk_aval_participante_token_aceptacion_id
  FOREIGN KEY (token_aceptacion_id) REFERENCES token_verificacion (id) ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE candidato_reemplazo
  ADD CONSTRAINT fk_candidato_reemplazo_reemplazo_id
  FOREIGN KEY (reemplazo_id) REFERENCES reemplazo_participante (id) ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE candidato_reemplazo
  ADD CONSTRAINT fk_candidato_reemplazo_usuario_id
  FOREIGN KEY (usuario_id) REFERENCES usuario (id) ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE castigo_deuda
...
ALTER TABLE cobertura_incumplimiento
...
ALTER TABLE cobertura_incumplimiento
  ...
  FOREIGN KEY (fondo_id) REFERENCES fondo_garantia (id) ON DELETE RESTRICT ON UPDATE CASCADE;
...
ALTER TABLE cobertura_incumplimiento
  ...
  FOREIGN KEY (obligacion_id) REFERENCES obligacion_aporte (id) ON DELETE RESTRICT ON UPDATE CASCADE;
...
ALTER TABLE descargo_participante
...
ALTER TABLE deuda_participante
  ADD CONSTRAINT fk_deuda_participante_cobertura_id
  FOREIGN KEY (cobertura_id) REFERENCES cobertura_incumplimiento (id) ON DELETE SET NULL ON UPDATE CASCADE;
...
ALTER TABLE disolucion_anticipada
...
ALTER TABLE ejecucion_aval
  ...
  FOREIGN KEY (aval_id) REFERENCES aval_participante (id) ON DELETE RESTRICT ON UPDATE CASCADE;
...
ALTER TABLE evidencia_incumplimiento
  ...
  FOREIGN KEY (aportada_por) REFERENCES usuario (id) ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE evidencia_incumplimiento
  ADD CONSTRAINT fk_evidencia_incumplimiento_registro_id
  FOREIGN KEY (registro_id) REFERENCES registro_incumplimiento (id) ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE fondo_garantia
...
ALTER TABLE fondo_garantia
  ...
  FOREIGN KEY (politica_cobertura_id) REFERENCES politica_cobertura (id) ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE gestion_cobranza
  ADD CONSTRAINT fk_gestion_cobranza_estrategia_id
  FOREIGN KEY (estrategia_id) REFERENCES estrategia_cobranza (id) ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE gestion_cobranza
  ADD CONSTRAINT fk_gestion_cobranza_gestor_asignado_id
  FOREIGN KEY (gestor_asignado_id) REFERENCES usuario (id) ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE gestion_cobranza
  ADD CONSTRAINT fk_gestion_cobranza_registro_id
  FOREIGN KEY (registro_id) REFERENCES registro_incumplimiento (id) ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE historial_estado_incumplimiento
...
ALTER TABLE historial_incumplimiento_usuario
...
ALTER TABLE liquidacion_participante
  ...
  FOREIGN KEY (disolucion_id) REFERENCES disolucion_anticipada (id) ON DELETE RESTRICT ON UPDATE CASCADE;
...
ALTER TABLE lista_restriccion_interna
  ...
  FOREIGN KEY (registro_origen_id) REFERENCES registro_incumplimiento (id) ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE lista_restriccion_interna
  ADD CONSTRAINT fk_lista_restriccion_interna_retirado_por
  FOREIGN KEY (retirado_por) REFERENCES usuario (id) ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE lista_restriccion_interna
  ADD CONSTRAINT fk_lista_restriccion_interna_usuario_id
  FOREIGN KEY (usuario_id) REFERENCES usuario (id) ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE matriz_sancion
...
ALTER TABLE politica_cobertura
  ADD CONSTRAINT fk_politica_cobertura_grupo_id
  FOREIGN KEY (grupo_id) REFERENCES grupo (id) ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE politica_sancion
...
ALTER TABLE promesa_pago
  ...
  FOREIGN KEY (registrada_por) REFERENCES usuario (id) ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE reemplazo_participante
...
ALTER TABLE reemplazo_participante
  ...
  FOREIGN KEY (participante_entrante_id) REFERENCES participante (id) ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE reemplazo_participante
  ADD CONSTRAINT fk_reemplazo_participante_participante_saliente_id
  FOREIGN KEY (participante_saliente_id) REFERENCES participante (id) ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE reemplazo_participante
  ADD CONSTRAINT fk_reemplazo_participante_registro_id
  FOREIGN KEY (registro_id) REFERENCES registro_incumplimiento (id) ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE registro_incumplimiento
  ADD CONSTRAINT fk_registro_incumplimiento_cupo_id
  FOREIGN KEY (cupo_id) REFERENCES cupo (id) ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE registro_incumplimiento
  ADD CONSTRAINT fk_registro_incumplimiento_entrega_afectada_id
  FOREIGN KEY (entrega_afectada_id) REFERENCES entrega_fondo (id) ON DELETE SET NULL ON UPDATE CASCADE;
...
ALTER TABLE registro_incumplimiento
  ...
  FOREIGN KEY (periodo_id) REFERENCES periodo (id) ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE registro_incumplimiento
  ADD CONSTRAINT fk_registro_incumplimiento_reportado_por
  FOREIGN KEY (reportado_por) REFERENCES usuario (id) ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE registro_incumplimiento
  ADD CONSTRAINT fk_registro_incumplimiento_responsable_gestion
  FOREIGN KEY (responsable_gestion) REFERENCES usuario (id) ON DELETE SET NULL ON UPDATE CASCADE;
...
ALTER TABLE sancion
  ...
  FOREIGN KEY (aplicada_por) REFERENCES usuario (id) ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE sancion
  ADD CONSTRAINT fk_sancion_matriz_id
  FOREIGN KEY (matriz_id) REFERENCES matriz_sancion (id) ON DELETE SET NULL ON UPDATE CASCADE;
...
ALTER TABLE score_riesgo_incumplimiento
...
ALTER TABLE subrogacion
  ADD CONSTRAINT fk_subrogacion_cobertura_id
  FOREIGN KEY (cobertura_id) REFERENCES cobertura_incumplimiento (id) ON DELETE RESTRICT ON UPDATE CASCADE;
