...
CREATE TABLE IF NOT EXISTS beneficiario_final (
...
COMMENT ON TABLE beneficiario_final IS 'Módulo 12 — Cumplimiento Regulatorio y Consumidor Financiero. Que una inspección se responda con consultas, no armando carpetas';
COMMENT ON COLUMN beneficiario_final.id IS 'PK';
COMMENT ON COLUMN beneficiario_final.usuario_id IS 'FK, IDX, M1';
COMMENT ON COLUMN beneficiario_final.tipo_control IS 'CK';
