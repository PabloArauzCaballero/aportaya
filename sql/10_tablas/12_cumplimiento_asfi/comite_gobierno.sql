...
CREATE TABLE IF NOT EXISTS comite_gobierno (
...
COMMENT ON TABLE comite_gobierno IS 'Módulo 12 — Cumplimiento Regulatorio y Consumidor Financiero. Que una inspección se responda con consultas, no armando carpetas';
COMMENT ON COLUMN comite_gobierno.id IS 'PK';
COMMENT ON COLUMN comite_gobierno.tipo IS 'CK, UQ';
COMMENT ON COLUMN comite_gobierno.periodicidad_minima IS 'CK';
