...
COMMENT ON TABLE orden_retiro IS 'Módulo 10 — Billetera, Custodia y Dinero Electrónico. El saldo no se guarda: se deriva, y todos los días cuadra contra el banco';
COMMENT ON COLUMN orden_retiro.id IS 'PK';
COMMENT ON COLUMN orden_retiro.cuenta_billetera_id IS 'FK, IDX';
