...
COMMENT ON TABLE politica_retencion IS 'Módulo 09 — Auditoría, Reportes y Cumplimiento. Poder demostrar todo lo anterior ante un reclamo o un regulador';
COMMENT ON COLUMN politica_retencion.id IS 'PK';
COMMENT ON COLUMN politica_retencion.entidad IS 'UQ';
COMMENT ON COLUMN politica_retencion.accion_al_vencer IS 'CK';
