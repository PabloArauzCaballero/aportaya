...
CREATE TABLE IF NOT EXISTS definicion_reporte (
...
COMMENT ON TABLE definicion_reporte IS 'Módulo 09 — Auditoría, Reportes y Cumplimiento. Poder demostrar todo lo anterior ante un reclamo o un regulador';
COMMENT ON COLUMN definicion_reporte.id IS 'PK';
COMMENT ON COLUMN definicion_reporte.tipo IS 'CK';
COMMENT ON COLUMN definicion_reporte.nombre IS 'UQ';
