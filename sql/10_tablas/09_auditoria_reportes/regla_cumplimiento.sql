...
CREATE TABLE IF NOT EXISTS regla_cumplimiento (
...
COMMENT ON TABLE regla_cumplimiento IS 'Módulo 09 — Auditoría, Reportes y Cumplimiento. Poder demostrar todo lo anterior ante un reclamo o un regulador';
COMMENT ON COLUMN regla_cumplimiento.id IS 'PK';
COMMENT ON COLUMN regla_cumplimiento.codigo IS 'UQ';
COMMENT ON COLUMN regla_cumplimiento.categoria IS 'CK';
COMMENT ON COLUMN regla_cumplimiento.umbral IS 'NULL';
COMMENT ON COLUMN regla_cumplimiento.ventana_horas IS 'NULL';
COMMENT ON COLUMN regla_cumplimiento.severidad IS 'CK';
COMMENT ON COLUMN regla_cumplimiento.accion_automatica IS 'CK';
