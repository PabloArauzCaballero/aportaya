...
COMMENT ON TABLE periodo_contable IS 'Módulo 13 — Contabilidad Financiera y ERP. Que cerrar un mes no dependa de un Excel armado a mano';
COMMENT ON COLUMN periodo_contable.id IS 'PK';
COMMENT ON COLUMN periodo_contable.ejercicio_fiscal_id IS 'FK, IDX';
COMMENT ON COLUMN periodo_contable.mes IS 'CK: 1-12';
COMMENT ON COLUMN periodo_contable.estado IS 'CK, IDX';
