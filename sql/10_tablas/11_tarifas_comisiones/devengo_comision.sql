...
CREATE TABLE IF NOT EXISTS devengo_comision (
...
COMMENT ON TABLE devengo_comision IS 'Módulo 11 — Tarifas, Comisiones, Impuestos y Facturación. [append-only] La política de cobro es dato, no código: se cambia con un seeder';
COMMENT ON COLUMN devengo_comision.id IS 'PK';
COMMENT ON COLUMN devengo_comision.concepto_tarifa_id IS 'FK, IDX';
COMMENT ON COLUMN devengo_comision.tarifario_id IS 'FK, IDX';
COMMENT ON COLUMN devengo_comision.cotizacion_id IS 'FK, NULL, UQ';
COMMENT ON COLUMN devengo_comision.grupo_id IS 'FK, NULL, IDX, M2';
COMMENT ON COLUMN devengo_comision.participante_id IS 'FK, NULL, M2';
COMMENT ON COLUMN devengo_comision.usuario_obligado_id IS 'FK, IDX, M1';
COMMENT ON COLUMN devengo_comision.asiento_contable_id IS 'FK, NULL, M3';
COMMENT ON COLUMN devengo_comision.referencia_tipo IS 'CK';
COMMENT ON COLUMN devengo_comision.referencia_id IS 'IDX, polimorfica';
COMMENT ON COLUMN devengo_comision.monto_comision IS 'CK: >= 0';
