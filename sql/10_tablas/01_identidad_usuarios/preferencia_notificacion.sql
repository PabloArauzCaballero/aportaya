...
COMMENT ON TABLE preferencia_notificacion IS 'Módulo 01 — Identidad, Usuarios y Seguridad. Saber con certeza a quién le estás confiando plata ajena';
COMMENT ON COLUMN preferencia_notificacion.id IS 'PK';
COMMENT ON COLUMN preferencia_notificacion.usuario_id IS 'FK, UQ';
COMMENT ON COLUMN preferencia_notificacion.canal_primario IS 'CK';
COMMENT ON COLUMN preferencia_notificacion.canal_respaldo IS 'CK, NULL';
COMMENT ON COLUMN preferencia_notificacion.hora_no_molestar_desde IS 'NULL';
COMMENT ON COLUMN preferencia_notificacion.hora_no_molestar_hasta IS 'NULL';
