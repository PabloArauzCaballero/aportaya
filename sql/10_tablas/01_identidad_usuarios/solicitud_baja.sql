...
COMMENT ON TABLE solicitud_baja IS 'Módulo 01 — Identidad, Usuarios y Seguridad. Saber con certeza a quién le estás confiando plata ajena';
COMMENT ON COLUMN solicitud_baja.id IS 'PK';
COMMENT ON COLUMN solicitud_baja.usuario_id IS 'FK, IDX';
COMMENT ON COLUMN solicitud_baja.fecha_efectiva IS 'NULL';
