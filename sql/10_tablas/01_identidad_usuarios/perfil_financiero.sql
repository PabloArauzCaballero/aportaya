...
COMMENT ON TABLE perfil_financiero IS 'Módulo 01 — Identidad, Usuarios y Seguridad. Saber con certeza a quién le estás confiando plata ajena';
COMMENT ON COLUMN perfil_financiero.id IS 'PK';
COMMENT ON COLUMN perfil_financiero.usuario_id IS 'FK, UQ';
