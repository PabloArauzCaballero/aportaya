...
COMMENT ON TABLE token_verificacion IS 'Módulo 01 — Identidad, Usuarios y Seguridad. Saber con certeza a quién le estás confiando plata ajena';
COMMENT ON COLUMN token_verificacion.id IS 'PK';
COMMENT ON COLUMN token_verificacion.usuario_id IS 'FK, NULL, IDX';
COMMENT ON COLUMN token_verificacion.politica_id IS 'FK';
COMMENT ON COLUMN token_verificacion.dispositivo_id IS 'FK, NULL';
COMMENT ON COLUMN token_verificacion.tipo_token IS 'CK: OTP|ENLACE|REFRESCO';
COMMENT ON COLUMN token_verificacion.proposito IS 'IDX';
COMMENT ON COLUMN token_verificacion.hash_token IS 'UQ';
COMMENT ON COLUMN token_verificacion.estado IS 'IDX';
COMMENT ON COLUMN token_verificacion.expira_en IS 'IDX';
COMMENT ON COLUMN token_verificacion.enviado_en IS 'NULL';
COMMENT ON COLUMN token_verificacion.consumido_en IS 'NULL';
...
COMMENT ON COLUMN token_verificacion.uso_unico IS 'NULL, subtipo ENLACE';
COMMENT ON COLUMN token_verificacion.clicks IS 'NULL, subtipo ENLACE';
COMMENT ON COLUMN token_verificacion.familia_id IS 'NULL, subtipo REFRESCO';
COMMENT ON COLUMN token_verificacion.rotado_de_id IS 'FK, NULL, subtipo REFRESCO';
