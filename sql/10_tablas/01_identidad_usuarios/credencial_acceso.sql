...
COMMENT ON TABLE credencial_acceso IS 'Módulo 01 — Identidad, Usuarios y Seguridad. Saber con certeza a quién le estás confiando plata ajena';
COMMENT ON COLUMN credencial_acceso.id IS 'PK';
COMMENT ON COLUMN credencial_acceso.usuario_id IS 'FK, UQ';
COMMENT ON COLUMN credencial_acceso.expira_en IS 'NULL';
