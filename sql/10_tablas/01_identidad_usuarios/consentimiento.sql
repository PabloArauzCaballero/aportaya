...
COMMENT ON TABLE consentimiento IS 'Módulo 01 — Identidad, Usuarios y Seguridad. Saber con certeza a quién le estás confiando plata ajena';
COMMENT ON COLUMN consentimiento.id IS 'PK';
COMMENT ON COLUMN consentimiento.usuario_id IS 'FK, IDX';
COMMENT ON COLUMN consentimiento.tipo IS 'CK';
COMMENT ON COLUMN consentimiento.revocado_en IS 'NULL';
