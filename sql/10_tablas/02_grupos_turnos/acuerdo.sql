...
COMMENT ON TABLE acuerdo IS 'Módulo 02 — Grupos, Cupos, Turnos y Gobernanza. Reglas del juego, orden de cobro y decisiones colectivas';
COMMENT ON COLUMN acuerdo.id IS 'PK';
COMMENT ON COLUMN acuerdo.grupo_id IS 'FK, IDX';
COMMENT ON COLUMN acuerdo.tipo IS 'CK';
