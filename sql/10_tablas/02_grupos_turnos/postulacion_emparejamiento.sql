...
CREATE TABLE IF NOT EXISTS postulacion_emparejamiento (
...
COMMENT ON TABLE postulacion_emparejamiento IS 'Módulo 02 — Grupos, Cupos, Turnos y Gobernanza. Reglas del juego, orden de cobro y decisiones colectivas';
COMMENT ON COLUMN postulacion_emparejamiento.id IS 'PK';
COMMENT ON COLUMN postulacion_emparejamiento.usuario_id IS 'FK, IDX';
COMMENT ON COLUMN postulacion_emparejamiento.preferencia_turno IS 'CK';
COMMENT ON COLUMN postulacion_emparejamiento.estado IS 'CK, IDX';
