...
COMMENT ON TABLE configuracion_grupo IS 'Módulo 02 — Grupos, Cupos, Turnos y Gobernanza. Reglas del juego, orden de cobro y decisiones colectivas';
COMMENT ON COLUMN configuracion_grupo.grupo_id IS 'PK, FK';
COMMENT ON COLUMN configuracion_grupo.politica_mora_id IS 'FK, NULL';
COMMENT ON COLUMN configuracion_grupo.politica_sancion_id IS 'FK, NULL';
