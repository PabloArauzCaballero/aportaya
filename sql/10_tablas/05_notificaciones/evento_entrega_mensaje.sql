...
CREATE TABLE IF NOT EXISTS evento_entrega_mensaje (
...
COMMENT ON TABLE evento_entrega_mensaje IS 'Módulo 05 — Notificaciones y Comunicaciones. WhatsApp como canal real de cobro, sin spam ni doble aviso';
COMMENT ON COLUMN evento_entrega_mensaje.id IS 'PK';
