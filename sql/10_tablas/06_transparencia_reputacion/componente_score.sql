...
CREATE TABLE IF NOT EXISTS componente_score (
...
COMMENT ON TABLE componente_score IS 'Módulo 06 — Transparencia y Reputación. Que nadie tenga que "creerle" al organizador';
COMMENT ON COLUMN componente_score.id IS 'PK';
COMMENT ON COLUMN componente_score.puntaje_id IS 'FK, IDX';
COMMENT ON COLUMN componente_score.codigo_factor IS 'UQ+puntaje_id';
COMMENT ON COLUMN componente_score.tendencia IS 'CK';
