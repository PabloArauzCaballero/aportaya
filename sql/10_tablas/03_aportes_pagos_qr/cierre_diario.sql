...
COMMENT ON TABLE cierre_diario IS 'Módulo 03 — Aportes, Pagos QR y Conciliación. Que "pagué" signifique "el banco lo confirmó"';
COMMENT ON COLUMN cierre_diario.id IS 'PK';
COMMENT ON COLUMN cierre_diario.fecha IS 'UQ';
COMMENT ON COLUMN cierre_diario.cerrado_por IS 'FK';
COMMENT ON COLUMN cierre_diario.reabierto_en IS 'NULL';
