...
CREATE TABLE IF NOT EXISTS obligacion_aporte (
...
COMMENT ON TABLE obligacion_aporte IS 'Módulo 03 — Aportes, Pagos QR y Conciliación. Que "pagué" signifique "el banco lo confirmó"';
COMMENT ON COLUMN obligacion_aporte.id IS 'PK';
COMMENT ON COLUMN obligacion_aporte.grupo_id IS 'FK, IDX';
COMMENT ON COLUMN obligacion_aporte.periodo_id IS 'FK, IDX';
COMMENT ON COLUMN obligacion_aporte.cupo_id IS 'FK, IDX';
COMMENT ON COLUMN obligacion_aporte.participante_id IS 'FK, IDX';
COMMENT ON COLUMN obligacion_aporte.politica_mora_id IS 'FK, NULL';
COMMENT ON COLUMN obligacion_aporte.obligacion_origen_id IS 'FK, NULL';
COMMENT ON COLUMN obligacion_aporte.plan_regularizacion_id IS 'FK, NULL';
COMMENT ON COLUMN obligacion_aporte.tipo IS 'CK';
COMMENT ON COLUMN obligacion_aporte.monto_esperado IS 'CK: > 0';
COMMENT ON COLUMN obligacion_aporte.saldo_pendiente IS 'GENERATED';
COMMENT ON COLUMN obligacion_aporte.estado IS 'CK, IDX';
COMMENT ON COLUMN obligacion_aporte.fecha_vencimiento IS 'IDX';
COMMENT ON COLUMN obligacion_aporte.fecha_pago_efectivo IS 'NULL';
